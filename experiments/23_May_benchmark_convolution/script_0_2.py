...
try:
    ...
    with open('results_convolution_0.csv', 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([1, 1, 16, 3, 2, 32, 64, flops, ms, "internal"])
except Exception as e:
    error_msg = "There was an exception running the following parameters: 1, 1, 16, 3, 2, 32, 64, internal on gpu:0\n"
