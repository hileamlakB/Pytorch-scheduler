...
try:
    x = torch.randn(1, 1, 64, 64, device="cuda", dtype=torch.float32)
    ...
    with open('results_convolution_2.csv', 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([1, 1, 16, 3, 2, 64, 64, flops, ms, "internal"])
except Exception as e:
    error_msg = "There was an exception running the following parameters: 1, 1, 16, 3, 2, 64, 64, internal on gpu:2\n"
