...
try:
    x = torch.randn(32, 3, 64, 64, device="cuda", dtype=torch.float32)
    ...
    with open('results_convolution_3.csv', 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([32, 3, 16, 3, 2, 64, 64, flops, ms, "external"])
except Exception as e:
    error_msg = "There was an exception running the following parameters: 32, 3, 16, 3, 2, 64, 64, external on gpu:3\n"
