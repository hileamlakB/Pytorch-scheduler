...
try:
    x = torch.randn(1, 3, 64, 32, device="cuda", dtype=torch.float32)
    ...
    with open('results_convolution_0.csv', 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([1, 3, 16, 3, 2, 64, 32, flops, ms, "internal"])
except Exception as e:
    error_msg = "There was an exception running the following parameters: 1, 3, 16, 3, 2, 64, 32, internal on gpu:0\n"
