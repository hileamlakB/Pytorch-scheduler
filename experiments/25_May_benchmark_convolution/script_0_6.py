...
try:
    ...
    with open('results_convolution_0.csv', 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([32, 1, 16, 3, 1, 32, 32, flops, ms, "internal"])
except Exception as e:
    error_msg = "There was an exception running the following parameters: 32, 1, 16, 3, 1, 32, 32, internal on gpu:0\n"
