...
try:
    ...
    error_msg = f"There was an exception running the following parameters: {batch_size}, {in_channels}, {out_channels}, {kernel_size}, {stride}, {width}, {height}, {ltype}\n"
...
os.remove(__file__)
        """)
            ...
            logger.info(f"Appended process {i} running script_{gpu}_{i} to processes")
