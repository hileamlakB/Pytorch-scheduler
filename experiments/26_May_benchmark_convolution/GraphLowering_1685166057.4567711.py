...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.addmm(primals_2, primals_3, as_strided(primals_1, (1024, 512), (1, 1024)), alpha=1, beta=1, out=buf0)
        del primals_1
        del primals_2
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_3 = rand_strided((1, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
